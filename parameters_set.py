...
class ParametersSet:
    """
        x (float) : latitude (decimal degrees) E.g: 5 \n
        y (float) : longitude (decimal degrees) E.g: 5 \n
        ...
        number_divisions (tuple) : the number of divisions (usually months) for each variable. ndivisions=12 for climatic
        variables and ndivisions=1 for bioclimatic (or other types of variables) variables. E.g: (12,12) \n
